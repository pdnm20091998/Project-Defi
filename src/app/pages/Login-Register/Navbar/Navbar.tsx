    ...
    <Div>
      ...
      <Navbar expand="xl">
        <Container fluid>
          ...
          <Form>
            <NavBtn width="100px" className={`ms-3 ${styles.remove}`}>
              Buy DFY
            </NavBtn>
            <NavBtn width="100px" className="ms-3">
              Connect
            </NavBtn>
            <NavBtn width="80px" className={`ms-3 ${styles.remove}`}>
              Login
            </NavBtn>
            {clicked === true ? (
              <FontAwesomeIcon
      ...
      <Collapse in={open}>
        <MiniNav id="nav" className={styles.miniNav}>
          <Image
            ...
            rounded
          />
          <NavBtn width="80px" className="mt-2 mx-auto d-block">
            Login
          </NavBtn>
